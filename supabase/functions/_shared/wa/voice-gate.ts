...
// (aprovacao explicita do dono no chat). O contrato do block (decisao do dono
// 19/07, modelo FIXO do produto): o agente CORRIGE o texto e reenvia ate passar
// — nao existe fluxo de aprovacao de mensagem. So severity=high entra no gate —
// medium/low seguem como feedback do check_message, nunca barram envio.
